...
products.forEach(product => {
  ...
  productCardElement.appendChild(createProductDescription(product.description));
...
function addProductToCart(productId) {
  ...
  if (cart.some(product => product.id === productId)) {
    ...
    cartListElement.appendChild(
      createProductImage(productDetails.image, productDetails.name)
    );
    cartListElement.appendChild(createProductName(productDetails.name));
  }
...
function createCartList() {
  ...
  cartList.setAttribute("id", "cart-list-container");
...
function createCartListCloseButton() {
  ...
  cartListCloseButton.setAttribute("id", "cart-details-close-button");
  cartListCloseButton.innerHTML =
    ' <i class="fa-solid fa-xmark" id="buton-inchis"></i> ';
...
function showCart() {
  if (cartListElement.style.display === "block")
    cartListElement.style.display = "none";
  else cartListElement.style.display = "block";
}
